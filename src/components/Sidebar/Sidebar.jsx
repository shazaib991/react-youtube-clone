      ...
      >
        ...
        >
          <div
            className={`${
              ...
              sidebarBurgerMenuClick ? "pb-[14px]" : "py-[9px]"
            } ${sidebarBurgerMenuClick ? "pt-[18px]" : ""} text-[20px]`}
          >
        ...
        <div className={`${sidebarBurgerMenuClick ? "hidden" : ""}`}>
          ...
          <a
            ...
            title="Trending"
          >
            <WhatshotOutlinedIcon className="ml-[16px]" fontSize="inherit" />
            <WhatshotIcon
              className="ml-[16px]"
              style={{ display: "none" }}
              fontSize="inherit"
          ...
          <a
            ...
            title="Music"
          >
            <MusicNoteOutlinedIcon className="ml-[16px]" fontSize="inherit" />
            <MusicNoteIcon
              className="ml-[16px]"
              style={{ display: "none" }}
              fontSize="inherit"
          ...
          <a
            ...
            title="News"
          >
            <FeedOutlinedIcon className="ml-[16px]" fontSize="inherit" />
            <FeedIcon
              className="ml-[16px]"
              style={{ display: "none" }}
              fontSize="inherit"
          ...
          <a
            ...
            title="Sports"
          >
            <EmojiEventsOutlinedIcon className="ml-[16px]" fontSize="inherit" />
            <EmojiEventsIcon
              className="ml-[16px]"
              style={{ display: "none" }}
              fontSize="inherit"
          ...
          >
            <AddCircleOutlineIcon className="ml-[16px]" fontSize="inherit" />
            <AddCircleIcon
              className="ml-[16px]"
              style={{ display: "none" }}
              fontSize="inherit"
          ...
          <a
            ...
            title="Settings"
          >
            <SettingsOutlinedIcon className="ml-[16px]" fontSize="inherit" />
            <SettingsIcon
              className="ml-[16px]"
              style={{ display: "none" }}
              fontSize="inherit"
          ...
          >
            <FlagOutlinedIcon className="ml-[16px]" fontSize="inherit" />
            <FlagIcon
              className="ml-[16px]"
              style={{ display: "none" }}
              fontSize="inherit"
          ...
          <a
            ...
            title="Help"
          >
            <HelpOutlineOutlinedIcon className="ml-[16px]" fontSize="inherit" />
            <HelpIcon
              className="ml-[16px]"
              style={{ display: "none" }}
              fontSize="inherit"
          ...
          <a
            ...
            title="Send feedback"
          >
            <FeedbackOutlinedIcon className="ml-[16px]" fontSize="inherit" />
            <FeedbackIcon
              className="ml-[16px]"
              style={{ display: "none" }}
              fontSize="inherit"
